...
=====================
E-Commerce Sales & Customer Analysis: single-file project
(data loading + cleaning + analysis + Streamlit dashboard).

Run with:
    streamlit run ecommerce_analysis.py

The dataset CSV (ecommerce_sales_customer_analysis_dataset.csv) must be
...
# =============================================================================
# PART 1: DATA LOADING, VALIDATION, CLEANING & FEATURE ENGINEERING
# =============================================================================

# ─── Path resolution ──────────────────────────────────────────────────────────
_THIS_DIR = os.path.dirname(os.path.abspath(__file__))
_CSV_NAME = "ecommerce_sales_customer_analysis_dataset.csv"
# Dataset is expected in the same folder as this file (fallback: parent folder)
_DEFAULT_CSV = os.path.join(_THIS_DIR, _CSV_NAME)
...
# =============================================================================
# PART 2: ANALYSIS (KPIs, aggregations, business insights)
# =============================================================================
